...
let tabDescription = [
  {
    paragraph:
      "We want patients to find the perfect doctor and book an appointment in the most easy way. The patient journey should be enjoyable, and thats why we are always next to them: to help them find the best possible care. Anytime, anywhere."
  },
  {
    paragraph:
...
let tabCard = [
  ...
  },
  {
    ...
    //country: ["CHOSE COUNTRY", "ARGENTINA","AUSTRALIA", "BRESIL", "GERMANY", "TUNISIA", "FRANCE", "ENGLAND", "MAROC", "ESPAGNE", "ITALIE"],
...
let tabParty = [
  {
    ...
    subject: "Leader in 10 countries",
    details:
  ...
  },
  {
    ...
    subject: "1.5 million appointments",
    details: "booked last month"
  },
  {
    image: "https://www.docplanner.com/img/patients.png",
    subject: "30 million unique patients",
    details: "visit us every month",
    padding: "padding"
  },
  {
    image: "https://www.docplanner.com/img/doctors.png",
    subject: "2 million active doctors",
    details: "trust in our solutions"
  }
];
let tableImageCountrty = [
  {
    ...
    <div>
      ...
      <main>
        <div className="bloc">
          ...
          />
          <p className="item-making">
            Making the healthcare experience more human
          </p>

          <Description descriptionList={tabDescription} />
          <Card cardList={tabCard} />
          <div className="culture-company">
            <Culture />
            <Company companyList={tabCompany} />
          </div>
        </div>
        <div
          className="platform"
        ...
        >
          <img
            ...
            src={
              "https://res-5.cloudinary.com/crunchbase-production/image/upload/c_lpad,f_auto,q_auto:eco/jcmy9zzlqh682l0my9p3"
            }
          />
          <div className="item-platform">
            <div className="bloc-platform">
              <p className="description-platform">
                The world's biggest healthcare platform
              </p>
              <p className="introduction-patient">
                We work from 6 offices all over the world, bringing Docplanner
                Group to life in almost 20 countries.
              </p>
            </div>
            <Party partyList={tabParty} />
          </div>
        </div>

        {/* ------------------------- */}
        <div className="bloc-img-country">
          <div>
            <div>
              <p class="item-making">Improve the lives of millions.</p>
              <p class="item-making">Change yours forever</p>
            </div>
          </div>
          <div>
            <p class="introduction-patient">
          ...
          <div>
            <ImageCountry ListImageCountry={tableImageCountrty} />
          </div>
        </div>
        {/*--------------------------- */}
      </main>
      ...
      <footer>
        <p class="parag-footer border">
          We are leaders in 10 countries:{" "}
          <a class="link-country" href="#">
          Poland,
          </a>{" "}
          <a class="link-country" href="#">
            Turkey,
        ...
        <p class="parag-footer"> www.docplanner.com © 2019</p>
      </footer>
    </div>
  );
}
